...
template<class ItemType, class KeyType, class ItemTypeQueue>
...
public:
    ...
    virtual bool remove(const KeyType& searchKey, const ItemTypeQueue& newItem) = 0;
    ...
    virtual bool enqueue(const KeyType& searchKey, const ItemTypeQueue& newItem)  const  = 0;
